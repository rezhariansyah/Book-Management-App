        ...
        <div className="limiter">
          ...
          >
            <div className="wrap-login100 p-t-30 p-b-50">
              <span className="login100-form-title p-b-41 mb-4">Account Login</span>
              <form className="login100-form validate-form p-b-33 p-t-5">
                ...
                <div className="row justify-content-center mt-3 baru">
                  <input type="button" style={{width:"100px"}} className="btn btn-outline-danger rounded-pill" value="Login"/>
                </div>
              </form>
            </div>
          </div>
